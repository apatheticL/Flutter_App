...
import 'package:demo_navigator/share/widget/divider_widget.dart';
...
class _HomeState extends State<HomeBody> {
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                children: <Widget>[
                  // drawable line black
                  // _buildHeaderCategory(context, BookTypeEnum.PENDING_BOOK_TEXT,BookTypeEnum.PENDING_BOOK),
                  DividerWidget(
                    paddingVertical: 8,
                  ),
                ],
  ...
  //  Container _buildHeaderCategory(BuildContext context, String headerTitle, int type) {
  //   return
  //
  // }
